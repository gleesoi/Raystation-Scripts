...
def autoplan():
    ...
    ##new top level window instead of root 2. replace all top refs to top
    top = Toplevel()
    ...
    def autoWBF():
        ...
        def changeMachine_MLC():
            ...
            #varian left sided where bank X1 is post border MLC
            ...
            #then we can conform the mlc to field edges
            ...
            try:
                ...
                if plan.Name == 'Left Breast':
                    ...
                    with CompositeAction('ROI algebra (left lat marker roi)'):
                      ...
                      retval_0.UpdateDerivedGeometry(Examination=examination, Algorithm="Auto")
                    try: # try as maybe zero geometry and fail
                        #need to get center coordinates of ROI right tattoo ROI to use below to make poi tattoo in center
                        roi_geometries = case.PatientModel.StructureSets[examination.Name].RoiGeometries
        ...
        #increase lat ant border by 1cm and conform mlc to beam??
        ...
        def SortFlashLat():       
            ...
            ##save
            patient.Save()
            #await_user_input("check flash issue lat beam mlcs")
        ...
        PTV_v95 = beam_set.FractionDose.GetRelativeVolumeAtDoseValues(RoiName='PTVp_2600', DoseValues=[dose_value_v95])*100  ##this gets v24.7 in 5# = 494 * 100 = 95.22 (as was given as 0.9522) # tested in console # gives array eg ([89.8427])
        ...
        MyFileName = patient.PatientID + '_WB_' + str(staff_id) + '.txt'
        file = open(MyFileName, "w") # write mode over writes
        file.write("WB Script ran - start time: " + str(startTime)
    ...
    myButton = Button(top, text="Start WHOLE BREAST Plan 26Gy/5F", command=autoWBF)

    ##cancel button
    butt2 = Button(top, text = 'Cancel', command = Button_pressed2)

    myButton.place(x=150, y=150)
